...
public:
    ...
    std::pair<double, double> decayProbability(const Particle &particle);
...
private:
    ...
    std::vector<int> decayCountsPerStep;
    std::vector<int> initialDeltaCounts;
    std::vector<double> decayRatios;
